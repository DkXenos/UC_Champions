...
import "./styles.css";
import { finishedCompetitions, Winner, FinishedCompetition } from "../../lib/winner";
import {
  Pagination,
  PaginationContent,
  PaginationItem,
...
export default function AnnouncementsPage() {
  ...
  const [selectedCompetition, setSelectedCompetition] = useState<FinishedCompetition | null>(null);
